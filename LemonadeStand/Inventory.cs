...
namespace LemonadeStand
{
    class Inventory
    {
        ...
        {
            Console.WriteLine($" You Have {lemons.Count} Lemon(s)");
            Console.WriteLine($" You Have {sugarCubes.Count} Sugar Cube(s)");
            Console.WriteLine($" You Have {iceCubes.Count} Ice Cube(s)");
            Console.WriteLine($" You Have {cups.Count} cup(s)");
